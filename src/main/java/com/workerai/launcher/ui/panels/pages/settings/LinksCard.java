...
public class LinksCard extends Settings {
    public static void create(GridPane container, Saver saver, StackPane card) {
        ...
        createLabel(0, 50d, "Quick Links", JuiIcon.createFontIcon(-4d, 0, FontAwesomeIcon.SEND, "25px", null, Color.WHITE, card), "afterLaunch-label", Pos.TOP_CENTER, card);
        createLabel(0, 80d, "Need help? Have a look at our support section.", null, "afterLaunch-subLabel", Pos.TOP_CENTER, card);

        FontAwesomeIconView supportIcon = JuiIcon.createFontIcon(-2d, 0, FontAwesomeIcon.LIFE_RING, "16px", null, Color.WHITE, card);
        ...
        FontAwesomeIconView faqIcon = JuiIcon.createFontIcon(-2d, 0d, FontAwesomeIcon.QUESTION, "20px", null, Color.WHITE, card);
