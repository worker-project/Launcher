...
public class LegalCard extends Settings {
    public static void create(GridPane container, Saver saver, StackPane card) {
        ...
        createLabel(0, 50d, "Legal", JuiIcon.createFontIcon(-4d, 0d, FontAwesomeIcon.BOOK, "25px", null, WHITE, card), "afterLaunch-label", Pos.TOP_CENTER, card);
        createLabel(0, 80d, "Have a look at our terms of service & third-party licenses.", null, "afterLaunch-subLabel", Pos.TOP_CENTER, card);

        FontAwesomeIconView termsIcon = JuiIcon.createFontIcon(0, 0d, FontAwesomeIcon.BALANCE_SCALE, "16px", null, WHITE, card);
        ...
        FontAwesomeIconView licensesIcon = JuiIcon.createFontIcon(-2d, 0d, FontAwesomeIcon.SHARE_ALT, "16px", null, WHITE, card);
