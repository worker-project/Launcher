...
public class ResolutionCard extends Settings {
    ...
    private static void createResolutions(GridPane pane, TextField widthField, TextField heightField) {
        ...
        HBox box = createHBox(50, 10, 10, 10, 10);
        ...
        FontAwesomeIconView closeIcon = createAwesomeIcon(0d, 0d, FontAwesomeIcon.CLOSE, "25px", "close-button", Color.INDIANRED, null, Cursor.DEFAULT);
